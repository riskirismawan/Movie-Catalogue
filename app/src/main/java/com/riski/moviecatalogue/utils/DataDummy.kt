...
object DataDummy {
    ...
    fun generateDummyMovies(): List<MoviesItem> {
        ...
        val movie = ArrayList<MoviesItem>()

        movie.add(MoviesItem(id = 1,
        ...
        movie.add(MoviesItem(id = 11,
            title = "Mary Queen of Scots",
            posterPath = R.drawable.poster_marry_queen.toString(),
        ...
        movie.add(MoviesItem(id = 12,
            title = "Master Z: Ip Man Legacy",
            posterPath = R.drawable.poster_master_z.toString(),
        ...
        movie.add(MoviesItem(id = 13,
            title = "Mortal Engines",
            posterPath = R.drawable.poster_mortal_engines.toString(),
        ...
        movie.add(MoviesItem(id = 14,
            title = "Overlord",
            posterPath = R.drawable.poster_overlord.toString(),
        ...
        movie.add(MoviesItem(id = 15,
            title = "Ralph Breaks the Internet",
            posterPath = R.drawable.poster_ralph.toString(),
        ...
        movie.add(MoviesItem(id = 16,
            title = "Robin Hood",
            posterPath = R.drawable.poster_robin_hood.toString(),
        ...
        movie.add(MoviesItem(id = 17,
            title = "Serenity",
            posterPath = R.drawable.poster_serenity.toString(),
        ...
        movie.add(MoviesItem(id = 18,
            title = "Spider-Man: Into the Spider-Verse",
            posterPath = R.drawable.poster_spiderman.toString(),
        ...
        movie.add(MoviesItem(id = 19,
            title = "T-34",
            posterPath = R.drawable.poster_t34.toString(),
    ...
    fun generateDummyTvShows(): List<TvShowsItem> {

        val tvShow = ArrayList<TvShowsItem>()

        tvShow.add(TvShowsItem(id = 1,
            name = "Arrow",
            posterPath = R.drawable.poster_arrow.toString(),
            overview = "Spoiled billionaire playboy Oliver Queen is missing and presumed dead when his yacht is lost at sea. He returns five years later a changed man, determined to clean up the city as a hooded vigilante armed with a bow.",
            firstAirDate = "10/10/2012",
            genres = null))

        tvShow.add(TvShowsItem(id = 2,
            name = "Doom Patrol",
            posterPath = R.drawable.poster_doom_patrol.toString(),
        ...
        tvShow.add(TvShowsItem(id = 3,
            name = "Dragon Ball",
            posterPath = R.drawable.poster_dragon_ball.toString(),
        ...
        tvShow.add(TvShowsItem(id = 4,
            name = "Fairy Tail",
            posterPath = R.drawable.poster_fairytail.toString(),
        ...
        tvShow.add(TvShowsItem(id = 5,
            name = "Family Guy",
            posterPath = R.drawable.poster_family_guy.toString(),
        ...
        tvShow.add(TvShowsItem(id = 6,
            name = "The Flash",
            posterPath = R.drawable.poster_flash.toString(),
        ...
        tvShow.add(TvShowsItem(id = 8,
            name = "Gotham",
            posterPath = R.drawable.poster_gotham.toString(),
        ...
        tvShow.add(TvShowsItem(id = 9,
            name = "Grey's Anatomy",
            posterPath = R.drawable.poster_grey_anatomy.toString(),
            overview = "Follows the personal and professional lives of a group of doctors at Seattle’s Grey Sloan Memorial Hospital.",
            firstAirDate = "03/27/2005",
            genres = null))

        tvShow.add(TvShowsItem(id = 10,
            name = "Hanna",
            posterPath = R.drawable.poster_hanna.toString(),
        ...
        tvShow.add(TvShowsItem(id = 11,
            name = "Marvel's Iron Fist",
            posterPath = R.drawable.poster_iron_fist.toString(),
        ...
        tvShow.add(TvShowsItem(id = 12,
            name = "Naruto Shippūden",
            posterPath = R.drawable.poster_naruto_shipudden.toString(),
        ...
        tvShow.add(TvShowsItem(id = 13,
            name = "NCIS",
            posterPath = R.drawable.poster_ncis.toString(),
        ...
        tvShow.add(TvShowsItem(id = 14,
            name = "Riverdale",
            posterPath = R.drawable.poster_riverdale.toString(),
            overview = "Set in the present, the series offers a bold, subversive take on Archie, Betty, Veronica and their friends, exploring the surreality of small-town life, the darkness and weirdness bubbling beneath Riverdale’s wholesome facade.",
            firstAirDate = "01/26/2017",
            genres = null))

        tvShow.add(TvShowsItem(id = 15,
            name = "Shameless",
            posterPath = R.drawable.poster_shameless.toString(),
        ...
        tvShow.add(TvShowsItem(id = 16,
            name = "Supergirl",
            posterPath = R.drawable.poster_supergirl.toString(),
        ...
        tvShow.add(TvShowsItem(id = 17,
            name = "Supernatural",
            posterPath = R.drawable.poster_supernatural.toString(),
            overview = "When they were boys, Sam and Dean Winchester lost their mother to a mysterious and demonic supernatural force. Subsequently, their father raised them to be soldiers. He taught them about the paranormal evil that lives in the dark corners and on the back roads of America ... and he taught them how to kill it. Now, the Winchester brothers crisscross the country in their '67 Chevy Impala, battling every kind of supernatural threat they encounter along the way.",
            firstAirDate = "09/13/2005",
            genres = null))

        tvShow.add(TvShowsItem(id = 18,
            name = "The Simpsons",
            posterPath = R.drawable.poster_the_simpson.toString(),
            overview = "Set in Springfield, the average American town, the show focuses on the antics and everyday adventures of the Simpson family; Homer, Marge, Bart, Lisa and Maggie, as well as a virtual cast of thousands. Since the beginning, the series has been a pop culture icon, attracting hundreds of celebrities to guest star. The show has also made name for itself in its fearless satirical take on politics, media and American life in general.",
            firstAirDate = "12/17/1989",
            genres = null))

        tvShow.add(TvShowsItem(id = 19,
            name = "The Umbrella Academy",
            posterPath = R.drawable.poster_the_umbrella.toString(),
        ...
        tvShow.add(TvShowsItem(id = 20,
            name = "The Walking Dead",
            posterPath = R.drawable.poster_the_walking_dead.toString(),
